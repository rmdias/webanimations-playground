...
let dogSleepBtn = document.querySelector('#dog-sleep');
let doWakeupBtn = document.querySelector('#dog-wakeup');

dogSleepBtn.addEventListener('click', snoopSleepingAnimation);
doWakeupBtn.addEventListener('click', snoopWakeupAnimation);
